"""
Django settings for BookAndMusicSearchEngine project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-7_=q$h-%n9uil)d5n8k_bon5*fvoa9j=udiga9v@l5#v4928sy')
...
ROOT_URLCONF = 'BookAndMusicSearchEngine.urls'
...
WSGI_APPLICATION = 'BookAndMusicSearchEngine.wsgi.application'
